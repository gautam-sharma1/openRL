...
class Robot(Agent):
    def __init__(self,
        ...
        pygame.display.set_caption("Obstacle Avoidance using RL")
        self.step_size = 10
        self.side_size = 20
    ...
    def __get_random_pos(self):
        return Point(random.randint(0,400), random.randint(200+self.side_size,300-self.side_size))
        # return Point(
    ...
    def reset(self):
        self.robot_pos = Point(25, 250)  # TODO
        self.direction = Direction.RIGHT  # right
        self.reward = 0
        self.goal_pos = self.__get_random_pos() # obstacle in this case
    ...
    def graphics(self):
        ...
        pygame.draw.line(self.display, self.path_color, (0,200), (400,200), 10)
        pygame.draw.line(self.display, self.path_color, (0, 300), (400, 300), 10)
...
if __name__ == "__main__":
    ...
    PATH = './files/obstacle_avoidance.net'
    remember = ReplayBuffer(100, 1000000)
    r = Robot(400, 400)
    # for each obstacle -> 4 times state
